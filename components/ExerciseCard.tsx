...
export default function ExerciseCard({ exercise, safety, onPress }: ExerciseCardProps) {
  ...
  const borderColor = safety === 'safe' ? '#00B894' : safety === 'modify' ? '#FF9500' : '#FF3B30';
  ...
  return (
    ...
    >
      <View style={styles.iconContainer}>
        <MaterialIcons name={icon} size={24} color="#8E8E93" />
      </View>
      ...
      <View style={styles.right}>
        ...
        <MaterialIcons name="chevron-right" size={20} color="#AEAEB2" style={styles.chevron} />
      </View>
    </Pressable>
  );
}
