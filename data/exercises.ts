...
export const exerciseMods: Record<number, string> = {
  ...
  8: 'Only with trap bar. Avoid conventional deadlifts. Reduced weight, controlled form.',
...
export const exerciseFusionMods: Record<number, string> = {
  ...
  4: 'Well-suited post-surgery. Keep torso stationary. Don\'t lean forward past 90 degrees. Light to moderate weight.',
  5: 'Good option post-surgery. Spine well-supported. Don\'t let knees come too close to chest. Start with very light weight.',
  6: 'Avoid if upper thoracic fusion. For lumbar fusion: seated with back support, partial ROM, light weight only.',
  7: 'Gentle option post-surgery. Seated is preferred over standing to reduce spinal sway. No momentum.',
  8: 'Avoid post-fusion. Spinal compression + hip hinge motion puts excessive stress on fused and adjacent segments.',
  9: 'Gentle option post-surgery. Light resistance. May help rebuild upper back and shoulder posture.',
  ...
  12: 'Well-suited post-surgery. Low spinal load. Suitable for daily posture support. Start with light band.',
  13: 'Good option for upper fusion patients. Keep weight moderate, no arching.',
  14: 'Gentle option post-surgery. Keep weight light and focus on the squeeze. Standing or seated both fine.',
  15: 'Proceed with caution. Keep core rigid — no sagging. Wall push-ups or incline push-ups are lower-load alternatives.',
  16: 'Well-suited post-surgery. Spine supported by seat. Low spinal load.',
  17: 'Gentle option post-surgery. Lying position supports spine. Avoid seated leg curl if lumbar fusion.',
  ...
  20: 'Gentle option post-surgery. Seated reduces spinal sway. Keep weight very light.',
  ...
  24: 'Gentle option post-surgery. Seated preferred. No swinging or momentum.',
  25: 'Gentle option post-surgery. Keep elbows pinned to sides. No leaning forward. Use rope or bar attachment.',
  26: 'Caution with upper fusion — overhead position can stress thoracic segments. Use pushdowns as alternative.',
  27: 'Gentle option post-surgery. Constant tension throughout movement. Keep elbows stationary.',
  28: 'Well-suited post-surgery. Anti-rotation training may support spines with fusion. Keep weight very light.',
  29: 'Avoid post-fusion. Rotational movement directly stresses fused segments. Use Pallof Press as a lower-load alternative.',
  30: 'Gentle option post-surgery. Low spinal load in seated position.',
  31: 'Only for experienced lifters post-surgery. Requires good balance. Consider leg press single-leg as a lower-load alternative.',
  32: 'Well-suited post-surgery. Lying on back, low spinal compression. Suitable for rebuilding core activation.',
  33: 'Gentle option post-surgery. On hands and knees — low spinal load. Suitable for rebuilding back stability.',
  34: 'Proceed with caution. Keep hold times short (15-20s). Forearm plank is easier than full plank. Stop if any pain.',
  35: 'Only with light weight. Limit range of motion. Cable version is a lower-load option than dumbbell.',
  36: 'Gentle option post-surgery. Cable provides smooth resistance. Sit on a bench if standing is uncomfortable.',
};
